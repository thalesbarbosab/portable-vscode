...
connection.onInitialize(function (params) {
    ...
    var capabilities = {
        ...
        completionProvider: clientSnippetSupport ? { resolveProvider: true, triggerCharacters: __spreadArrays(emmetTriggerCharacters, ['.', ':', '<', '"', '=', '/']) } : undefined,
        hoverProvider: true,
...
connection.onCompletion(function (textDocumentPosition) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, errors_1.runSafe(function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (emmetCompletionList && emmetCompletionList.items) {
                                ...
                                return [2 /*return*/, { isIncomplete: true, items: __spreadArrays(emmetCompletionList.items, result.items) }];
                            }
